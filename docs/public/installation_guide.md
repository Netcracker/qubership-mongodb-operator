...
| `operator.priorityClassName`           | false     | string  | ""                                | Specifies [Priority Class](https://kubernetes.io/docs/concepts/scheduling-eviction/pod-priority-preemption/#priorityclass).                                                                                   |
...
| `mongodb.priorityClassName`           | false     | string  | ""                                | Specifies [Priority Class](https://kubernetes.io/docs/concepts/scheduling-eviction/pod-priority-preemption/#priorityclass).                                                                                  |
...
| `backup.priorityClassName`           | false     | string  | ""                                | Specifies [Priority Class](https://kubernetes.io/docs/concepts/scheduling-eviction/pod-priority-preemption/#priorityclass).                                                                                 |
...
| `dbaas.priorityClassName`           | false     | string  | ""                                | Specifies [Priority Class](https://kubernetes.io/docs/concepts/scheduling-eviction/pod-priority-preemption/#priorityclass).                                                                                |
...
| `prometheusExporter.priorityClassName`           | false     | string  | ""                                | Specifies [Priority Class](https://kubernetes.io/docs/concepts/scheduling-eviction/pod-priority-preemption/#priorityclass).                                                                                     |
...
| `robotTests.priorityClassName`           | false     | string  | ""                                | Specifies [Priority Class](https://kubernetes.io/docs/concepts/scheduling-eviction/pod-priority-preemption/#priorityclass).                                                                          |
